...
hi('ErrorMsg',     { fg = 'White', bg = '#440000',      ctermfg = 'White', ctermbg = 'DarkRed' })
...
hi('StatusLine',   { bg='#303030', fg='White',          cterm = { bold = true }, ctermbg='DarkGrey' })
hi('StatusLineNC', { bg='#202020', fg='LightGrey',      ctermbg='DarkGrey'  })
hi('TabLineFill',  { bg = '#000000',                    ctermbg='Black' })
hi('TabLineSel',   { fg='White', bg= '#202020', bold = true,        cterm = { bold = true } })
...
if vim.o.background == 'light' then
  ...
  hi('CursorLine',   { bg = '#101010',                             cterm = { underline = true } })
  hi('CursorLineNr', { fg = 'white', bg='#202020', bold = true,   ctermfg = 'Yellow', cterm = { underline = true } })
  ...
  hi('LineNr',       { fg = 'LightGrey', bg = '#101010',          ctermfg = 'lightgrey' })
  hi('MatchParen',   { bg = 'DarkCyan',                           ctermbg = 'DarkCyan' })
  hi('MoreMsg',      { fg = 'SeaGreen', bold = true,              ctermfg = 'LightGreen' })
  hi('Pmenu',        { bg = '#202020',                            ctermfg = 'White', ctermbg = 'DarkGrey' })
  hi('PmenuSel',     { bg = 'Blue',                               ctermfg = 'White', ctermbg = 'Blue' })
  hi('PmenuThumb',   { bg = 'White',                              ctermbg = 'White' })
  hi('Question',     { fg = 'Green', bold = true,                 ctermfg = 'LightGreen' })
  hi('Search',       { fg = 'none', bg = 'Blue',                  ctermfg = 'none', ctermbg = 'Blue' })
  ...
  hi('TabLine',      { bg = '#101010', fg ='LightGrey',           ctermfg = 'lightgrey', ctermbg = 'Black', cterm = { underline = true } })
  hi('Title',        { fg = 'Magenta', bold = true,               ctermfg = 'LightMagenta' })
  hi('Visual',       { fg = 'none', bg = '#004000',               ctermfg = 'Black', ctermbg = 'Grey' })
